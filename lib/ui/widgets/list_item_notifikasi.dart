...
class NotifikasiListItem extends StatelessWidget {
  ...
  NotifikasiListItem({required this.daftarDonasiDana, required this.itemWidth});
    ...
    return InkWell(
      onTap: () {
        Navigator.push(context,
            MaterialPageRoute(builder: (context) => BeriUcapanTerimakasih()));
      },
      child: Container(
              ...
              children: [
                ...
                Container(
                  width: MediaQuery.of(context).size.width -
                      (2 * defaultPaddingLR + 90),
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text(
                        'Donasi kamu sudah sampai! Beri ucapan terimakasih kepada donatur yuk',
